...
<template>
    <Head title="Write a Story | Almond-Blossoms" />
    ...
    <div class="mx-auto w-full max-w-[100rem] p-6 md:p-10 lg:p-12">
        ...
        >
            ...
            <!-- ========================================== -->
            <div class="flex w-full flex-col gap-12 lg:w-2/3 xl:w-3/4">
                <!-- The Writing Canvas -->
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div
                            ...
                            :class="{
                                '!border-none !bg-transparent !opacity-100 !shadow-none':
                                    !imagePreview,
                            }"
                        >
                            <UploadCloud
                                class="mx-auto mb-2 h-10 w-10 text-brand-wine/60"
                            />
                            <span
                            ...
                            <p
                                class="mt-2 hidden text-xs font-light text-brand-wine/50 sm:block"
                            >
                    ...
                    <div class="flex flex-col items-center p-8 sm:p-16">
                        <!-- Meta Data Display -->
                        <div
                            class="mb-8 flex items-center justify-center gap-6 text-brand-wine/40"
                        >
                            ...
                            <div
                                class="h-1 w-1 rounded-full bg-brand-rose/50"
                            ></div>
                            <div class="flex items-center gap-2">
                        ...
                        <p
                            ...
                            class="-mt-8 mb-4 text-center text-xs text-red-500"
                        >
                            {{ form.errors.title }}
                        </p>
                        ...
                        <p
                            ...
                            class="mt-4 text-center text-xs text-red-500"
                        >
                            {{ form.errors.content }}
                        </p>
                    </div>
                ...
                <div class="sticky top-24 flex flex-col gap-6 pb-12">
                    ...
                    >
                        ...
                        >
                            ...
                            {{
                                form.processing ? 'Saving...' : 'Publish Story'
                            }}
                        </button>
